...
class GFHANNANSMS_Pro_Entries_Sidebar
{
    ...
    public static function construct()
    {
        ...
        if (is_admin() && !empty(GFCommon::$version)) {
            ...
            add_action('wp_ajax_nopriv_sms_merge_tage_var_ajax', array('GFHANNANSMS_Pro_Entries_Sidebar', 'sms_merge_tage_var_ajax'));
            add_action('wp_ajax_sms_merge_tage_var_ajax', array('GFHANNANSMS_Pro_Entries_Sidebar', 'sms_merge_tage_var_ajax'));
        }
    }
    ...
    public static function send_sms_sidebar($arg_1, $arg_2)
    {
        ...
        if (rgpost("hannansms_send") && rgpost("gf_hannan_sms_sideber") && wp_verify_nonce(rgpost("gf_hannan_sms_sideber"), "send")) {
            ...
            $msg = GFCommon::replace_variables(wp_kses(rgpost('hannansms_text'), array('br' => array())), $form, $lead);
    ...
    <?php } ?>
        ...
        <form class="form_send_sms" method="post">
            ...
            <div id="minor-publishing" style="padding:10px;">
                ...
                <select style="width:100%" id="hannansms_text_variable_select" onchange="InsertMegeTag_SMS( 'hannansms_text' , 'variable_select', jQuery(this).val());">
        ...
        self::InsertMegeTag_SMS_JS($ajax, $form['id'], $lead['id']);
    } else { ?>
    ...
    public static function InsertMegeTag_SMS_JS($ajax = false, $form_id = 0, $lead_id = 0)
    { ?>
    ...
    public static function sms_merge_tage_var_ajax()
    {
        ...
        if ($form_id && $lead_id) {
            ...
            echo GFCommon::replace_variables($variable, $form, $lead, false, true, false);
        } else {
            echo $variable;
        }
        die();
