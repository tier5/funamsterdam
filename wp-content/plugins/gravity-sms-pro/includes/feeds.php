...
class GFHANNANSMS_Pro_Feeds
{
    ...
    public static function construct()
    {
        if (defined('RG_CURRENT_PAGE') && in_array(RG_CURRENT_PAGE, array('admin-ajax.php'))) {
            add_action('wp_ajax_gf_feed_ajax_active', array('GFHANNANSMS_Pro_Feeds', 'ajax'));
            add_action('wp_ajax_nopriv_gf_feed_ajax_active', array('GFHANNANSMS_Pro_Feeds', 'ajax'));
        }

        add_filter('gform_form_settings_menu', array('GFHANNANSMS_Pro_Feeds', 'toolbar'), 10, 2);
        add_action('gform_form_settings_page_sms', array('GFHANNANSMS_Pro_Feeds', 'sms_form_settings_page'));
    }
    ...
    public static function feeds($arg)
    {
        ...
        <div class="wrap">
            ...
            <?php if ($show) { ?>
                <img alt="<?php _e("HANNANStd", "GF_SMS") ?>" src="<?php echo GF_SMS_URL ?>/assets/images/logo.png"
            ...
            <form id="feed_form" method="post">
                ...
                <table class="wp-list-table widefat fixed striped toplevel_page_gf_edit_forms" cellspacing="0">
                    ...
                    <tr>
                        ...
                        <th scope="col" id="active" class="manage-column" style="width:60px;text-align:center"></th>
                        <th scope="col"
                                        ...
                                        <td class="column-date">
                                            <strong>
                                                <a href="<?php echo admin_url("admin.php?page=gf_entries&view=entries&id={$feed["form_id"]}"); ?>">
                                                    <?php echo RGFormsModel::get_lead_count($feed["form_id"], '', null, null, null, null, null); ?>
                                                </a>
                                            </strong>
                                        </td>
                                    <?php } ?>
