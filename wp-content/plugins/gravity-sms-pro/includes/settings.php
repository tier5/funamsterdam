...
class GFHANNANSMS_Pro_Settings
{
    ...
    public static function settings()
    {
        ...
        wp_enqueue_script('GF_SMS_Chosen', GF_SMS_URL . '/assets/chosen_v1.4.2/chosen.jquery.min.js', array(), true);
        wp_enqueue_style('GF_SMS_Chosen', GF_SMS_URL . '/assets/chosen_v1.4.2/chosen.min.css');
        ...
        <form method="post" action="">
            ...
            if (!empty($G_code) && $G_code != 'no') {
                ...
                if (GFHANNANSMS_Pro::credit() && $G_code == strtolower($settings["ws"])) {

                    $credit = GFHANNANSMS_Pro::credit();
            ...
            <table class="form-table">
                ...
                <tr>
                    <th scope="row">
                        <label for="gf_hannansms_to">
                            <?php _e("Your Default Numbers", "GF_SMS"); ?>
				...
				<tr>
                    ...
                    <td width="340">
                        ...
                        <label class="inline" for="gf_hannansms_sidebar_ajax_Yes"><?php _e("Yes", "GF_SMS"); ?></label>&nbsp;&nbsp;&nbsp;
