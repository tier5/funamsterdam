        ...
        <div class="wrap gforms_edit_form gf_browser_gecko">
            ...
            if (!rgempty("gf_hannansms_submit")) {
				...
				foreach ( $config["meta"] as $key => $val ) {
					...
					if ( in_array( $key , array( 'adminsms_conditional_operator' , 'clientsms_conditional_operator' ) ) && in_array( $val, array( '>' , '<' ) )  ) 
						$safe_data[$key] = $val;
					
					else if ( in_array( $key , array('message' , 'message_c' , 'adminsms_conditional_value' , 'clientsms_conditional_value' ) ) )
