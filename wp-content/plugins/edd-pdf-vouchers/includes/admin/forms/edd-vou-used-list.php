...
class EDD_Vou_List extends WP_List_Table {
	...
	function __construct(){
        ...
        global $edd_vou_model,$edd_vou_render;
		...
		$this->per_page	= apply_filters( 'edd_vou_used_posts_per_page', 10 ); // Per page
	...
	function column_default( $item, $column_name ){
        ...
        switch( $column_name ){
            ...
            case 'redeem_info' :
            	return $this->model->edd_vou_display_redeem_info_html( $item['ID'], $item['order_id'] );
	...
	function get_columns(){
        ...
        $columns = array(
							...
							'redeem_info'	=> __( 'Redeem Information' ),
				            ...
				            'redeem_by'		=>	__(	'Redeem By', 'eddvoucher' )*/
				        );
	...
	function get_sortable_columns() {
        ...
        $sortable_columns = array(
							            ...
							            //'download_title'	=>	array( 'download_title', true ),     //true means its already sorted
	...
	function no_items() {
		...
		_e( 'No used voucher codes yet.', 'eddvoucher' );
	}
