...
function fes_vendor_products_view( $vendor ) {
	...
	<div id="vendor-products-wrapper">
		...
		<?php
			...
			$products = EDD_FES()->vendors->get_products( $vendor->user_id );
						 ...
						 <?php
							...
							?>
							 <tr <?php if ( $i == 'alternate' ) { echo 'class="alternate"'; } ?>>
								...
								<td><a href="<?php echo esc_html( esc_url( admin_url( 'post.php?post='.$product->ID.'&action=edit' ) ) ); ?>"><?php echo esc_html( $product->post_title ); ?></a></td>
