<?php
// This file is directly copied out
// of WordPress core, only changing WP_List_Table
// to FES_List_Table. Thus this file is not altered
// in any other way to make it easier to upgrade (including
// phpdocs).
